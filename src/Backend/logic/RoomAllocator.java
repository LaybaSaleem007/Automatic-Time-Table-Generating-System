...
public class RoomAllocator {
    ...
    public Room allocateRoomWithPreferences(String preferredRoomType, int requiredCapacity, List<String> requiredEquipments,
                                            TimeSlot timeSlot, List<Room> availableRooms, List<TimetableEntry> existingSchedule) {
