...
public class Teacher extends User {
    ...
    public void setQualifiedSubjects(List<String> qualifiedSubjects) { this.qualifiedSubjects = qualifiedSubjects; }
    ...
    public void setAssignedSchedule(List<TimetableEntry> assignedSchedule) { this.assignedSchedule = assignedSchedule; }
    public void addQualifiedSubject(String subject) { this.qualifiedSubjects.add(subject); }
    public void setAvailabilityPreference(String day, List<String> timeSlots) { this.availability.put(day, timeSlots); }

    public boolean isAvailable(String day, String timeSlot) {
        // TEMPORARY FIX: Teachers are available for ALL time slots
        // This will allow timetable generation to work
    ...
    public boolean canTakeMoreHours() { return assignedHours < maxHoursPerWeek; }
    public void addAssignedHour() { this.assignedHours++; }
    public void removeAssignedHour() { if (this.assignedHours > 0) this.assignedHours--; }
    public void addToSchedule(TimetableEntry entry) { this.assignedSchedule.add(entry); addAssignedHour(); }
    public void removeFromSchedule(TimetableEntry entry) { this.assignedSchedule.remove(entry); removeAssignedHour(); }
